...
using namespace sgfilter;

#define sgs_error(msg) std::cerr << msg
...
double *sgfilter::calc_smooth(const int ndat, double *input,
...
#pragma omp parallel for private(i) schedule(static)
    ...
    float_vect out = sgfilter::smooth(in, window, order);
 ...
 * used. */
float_vect sgfilter::smooth(const float_vect &v, const int width, const int deg)
{
 ...
 *
 * In contrast to the smooth function we do a brute force attempt by
